...
function ow_customize_preview_js() {
	wp_enqueue_script( 'ow-customizer', get_template_directory_uri() . '/assets/js/underscores/customizer.js', array( 'customize-preview' ), '20151215', true );
}
